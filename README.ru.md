...
<p align="center">
  <a href="https://github.com/neket371/network-stealth-core/releases"><img alt="release" src="https://img.shields.io/badge/release-v7.5.3-0f766e"></a>
...
```bash
curl -fL https://raw.githubusercontent.com/neket371/network-stealth-core/v7.5.3/xray-reality.sh -o /tmp/xray-reality.sh
sudo XRAY_REPO_REF=v7.5.3 bash /tmp/xray-reality.sh install
```
