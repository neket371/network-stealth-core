...
Environment variables:
  ...
  GEO_VERIFY_HASH                Verify GeoIP/GeoSite SHA256 during update (default: true)
  GEO_VERIFY_STRICT              Fail update when GeoIP/GeoSite checksum is unavailable (default: false)
